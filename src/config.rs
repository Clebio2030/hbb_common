...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("MaxDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["maxdesk.csdigitalz.com.br"];
pub const RS_PUB_KEY: &str = "urKeVocAmrZgnzciDqRjYdFbYh8HfSswtRwxDIERXdk=";
